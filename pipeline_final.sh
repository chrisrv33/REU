...
#SBATCH --job-name="pl386-414"
#SBATCH -p batch
#SBATCH --array=386-414
...
SEQLIST=/rhome/cvaldez/bigdata/REU/data/accession_genomes/ftp_links.txt
...
bwa mem -t 8 -M $REFERENCE $TEMP_DIR/"$NAME"_1_trimmed_paired.fq.gz $TEMP_DIR/"$NAME"_2_trimmed_paired.fq.gz > $TEMP_DIR/"$NAME".sam
